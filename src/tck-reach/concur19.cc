...
node_t::node_t(tchecker::refzg::state_sptr_t const & s) : _state(s), _accepting(false) {}

node_t::node_t(tchecker::refzg::const_state_sptr_t const & s) : _state(s), _accepting(false) {}
