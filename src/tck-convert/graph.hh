...
#ifndef TCHECKER_TCK_INTERPOLATE_GRAPH_HH
#define TCHECKER_TCK_INTERPOLATE_GRAPH_HH
...
public:
  ...
  */
  edge_t(const tchecker::zg::transition_sptr_t t);
  ...
  */
  ...
  /*!
   ...
   \return shared pointer to the zone graph vedge in this edge
  */
  inline const tchecker::zg::transition_sptr_t transition_ptr() const {
    return _transition;
  }

private:
  tchecker::intrusive_shared_ptr_t<tchecker::shared_vedge_t const> _vedge; /*!< Tuple of edges */
  const tchecker::zg::transition_sptr_t _transition;
};
...
*/
class graph_t 
    : public tchecker::graph::reachability::multigraph_t<tchecker::tck_interpolate::node_t, tchecker::tck_interpolate::edge_t> {
public:
  /*!
   \brief Constructor
   \param zg : zone graph
  ...
  */
  ...
  using tchecker::graph::reachability::multigraph_t<tchecker::tck_interpolate::node_t, tchecker::tck_interpolate::edge_t>::attributes;
...
protected:
  ...
  */
  virtual void attributes(tchecker::tck_interpolate::node_t const & n, std::map<std::string, std::string> & m) const;
  ...
  */
  virtual void attributes(tchecker::tck_interpolate::edge_t const & e, std::map<std::string, std::string> & m) const;
...
#endif // TCHECKER_TCK_INTERPOLATE_GRAPH_HH
